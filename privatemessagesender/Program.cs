...
namespace privatemessagesender
{
    class Program
    {
        ...
        const string ServiceBusConnectionString = "Endpoint=sb://salesteamappcontoso2022gm.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=4s/f+Ug/4pRIFXee9o9dnhMO6AoRT7mB6+ASbEZ1Hs0=";
